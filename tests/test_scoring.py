...
class TestScoring(unittest.TestCase):
    ...
    def test_goals_scored(self):
        self.assertEqual(sc.goals_scored_by_pos(2, 'G'), 12)
        self.assertEqual(sc.goals_scored_by_pos(0, 'G'), 0)
        self.assertEqual(sc.goals_scored_by_pos(0, 'D'), 0)
        self.assertEqual(sc.goals_scored_by_pos(1, 'D'), 6)
        self.assertEqual(sc.goals_scored_by_pos(0, 'M'), 0)
        self.assertEqual(sc.goals_scored_by_pos(1, 'M'), 5)
        self.assertEqual(sc.goals_scored_by_pos(2, 'M'), 10)
        self.assertEqual(sc.goals_scored_by_pos(0, 'F'), 0)
        self.assertEqual(sc.goals_scored_by_pos(1, 'F'), 5)
        self.assertEqual(sc.goals_scored_by_pos(2, 'F'), 10)
        self.assertEqual(sc.goals_scored_by_pos(3, 'F'), 15)
    ...
    def test_clean_sheet(self):
        self.assertEqual(sc.clean_sheet_by_pos(0, 'G'), 0)
        self.assertEqual(sc.clean_sheet_by_pos(1, 'G'), 5)
        self.assertEqual(sc.clean_sheet_by_pos(0, 'D'), 0)
        self.assertEqual(sc.clean_sheet_by_pos(1, 'D'), 5)
        self.assertEqual(sc.clean_sheet_by_pos(0, 'M'), 0)
        self.assertEqual(sc.clean_sheet_by_pos(1, 'M'), 1)
        self.assertEqual(sc.clean_sheet_by_pos(0, 'F'), 0)
        self.assertEqual(sc.clean_sheet_by_pos(1, 'F'), 0)
        self.assertEqual(sc.clean_sheet_by_pos(0, 'D'), 0)
        self.assertEqual(sc.clean_sheet_by_pos(2, 'D'), 0)
        with self.assertRaises(ValueError):
            sc.clean_sheet_by_pos(3, 'u')
        with self.assertRaises(ValueError):
            sc.clean_sheet_by_pos(3, '')
    ...
    def test_goal_against(self):
        self.assertEqual(sc.goal_against_by_pos(0, 'D'), 0)
        self.assertEqual(sc.goal_against_by_pos(0, 'G'), 0)
        self.assertEqual(sc.goal_against_by_pos(0, 'M'), 0)
        self.assertEqual(sc.goal_against_by_pos(0, 'F'), 0)
        self.assertEqual(sc.goal_against_by_pos(1, 'D'), 0)
        self.assertEqual(sc.goal_against_by_pos(1, 'G'), 0)
        self.assertEqual(sc.goal_against_by_pos(1, 'M'), 0)
        self.assertEqual(sc.goal_against_by_pos(1, 'F'), 0)
        self.assertEqual(sc.goal_against_by_pos(2, 'D'), -1)
        self.assertEqual(sc.goal_against_by_pos(2, 'G'), -1)
        self.assertEqual(sc.goal_against_by_pos(2, 'M'), 0)
        self.assertEqual(sc.goal_against_by_pos(2, 'F'), 0)
        self.assertEqual(sc.goal_against_by_pos(3, 'D'), -1)
        self.assertEqual(sc.goal_against_by_pos(3, 'G'), -1)
        self.assertEqual(sc.goal_against_by_pos(3, 'M'), 0)
        self.assertEqual(sc.goal_against_by_pos(3, 'F'), 0)
        self.assertEqual(sc.goal_against_by_pos(4, 'D'), -2)
        self.assertEqual(sc.goal_against_by_pos(4, 'G'), -2)
        self.assertEqual(sc.goal_against_by_pos(5, 'D'), -2)
        self.assertEqual(sc.goal_against_by_pos(6, 'D'), -3)
        with self.assertRaises(ValueError):
            sc.goal_against_by_pos(2, 'U')
        with self.assertRaises(ValueError):
            sc.goal_against_by_pos(3, '')
